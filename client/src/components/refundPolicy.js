    ...
    <div className="generic refundPolicy">
      ...
      <div className="content">
        ...
        <section>
          ...
          <p>Thank you for shopping at Delivery Pay.</p>
          <p>
          ...
          <ul>
            <li>
              <p>
                ...
                in this Agreement) refers to Beautiful Concepts Pvt Ltd, C2,
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Delivery Pay, accessible from{" "}
                <a
                  href="https://www.deliverypay.in"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.deliverypay.in
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: returns@deliverpay.in</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://deliverypay.in/refundCancellationPolicy"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://deliverypay.in/refundCancellationPolicy
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +919557059871</p>
            </li>
          </ul>
          <p>
          ...
          <p>
            Directly to the Vendor on the Address Provided By the Vendor .
            Please Keep Proof of Courier / Return &amp; Provide Tracking
            Information . Un-trackable / Untraceable Returns will not be
            accepted , unless agreed upon in writing . Refunds will only be
            released upon satisfactory return of the order by the seller .
          </p>
          <p>
